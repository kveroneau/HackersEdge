...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.ordering'
        db.add_column(u'forums_topic', 'ordering',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.ordering'
        db.delete_column(u'forums_topic', 'ordering')
    ...
    models = {
        ...
        u'forums.thread': {
            'Meta': {'ordering': "['-last_updated']", 'object_name': 'Thread'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'valid_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']", 'null': 'True', 'blank': 'True'})
        },
        u'forums.topic': {
