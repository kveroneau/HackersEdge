...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.last_update'
        db.add_column(u'help_center_topic', 'last_update',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.last_update'
        db.delete_column(u'help_center_topic', 'last_update')
