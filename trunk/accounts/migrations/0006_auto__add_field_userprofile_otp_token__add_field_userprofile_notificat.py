...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.otp_token'
        db.add_column(u'accounts_userprofile', 'otp_token',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.notifications'
        db.add_column(u'accounts_userprofile', 'notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.otp_token'
        db.delete_column(u'accounts_userprofile', 'otp_token')

        # Deleting field 'UserProfile.notifications'
        db.delete_column(u'accounts_userprofile', 'notifications')
    ...
    models = {
        ...
        u'accounts.invite': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sent_invites'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'placed_on': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True'}),
            'taken_on': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.userprofile': {
            ...
            'otp_token': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
