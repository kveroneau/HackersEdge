...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invite.created_by'
        db.add_column(u'accounts_invite', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sent_invites', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invite.created_by'
        db.delete_column(u'accounts_invite', 'created_by_id')
