...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.designer'
        db.add_column(u'henet_host', 'designer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Host.available'
        db.add_column(u'henet_host', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.designer'
        db.delete_column(u'henet_host', 'designer_id')

        # Deleting field 'Host.available'
        db.delete_column(u'henet_host', 'available')
    ...
    models = {
        ...
        u'henet.host': {
            ...
            'designer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
