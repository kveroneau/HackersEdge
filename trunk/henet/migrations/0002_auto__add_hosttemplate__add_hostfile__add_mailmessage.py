...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HostTemplate'
        db.create_table(u'henet_hosttemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('ini', self.gf('django.db.models.fields.TextField')()),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'henet', ['HostTemplate'])

        # Adding model 'HostFile'
        db.create_table(u'henet_hostfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filename', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'henet', ['HostFile'])

        # Adding model 'MailMessage'
        db.create_table(u'henet_mailmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('from_who', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('to', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
        ...
        db.send_create_signal(u'henet', ['MailMessage'])


    def backwards(self, orm):
        # Deleting model 'HostTemplate'
        db.delete_table(u'henet_hosttemplate')

        # Deleting model 'HostFile'
        db.delete_table(u'henet_hostfile')

        # Deleting model 'MailMessage'
        db.delete_table(u'henet_mailmessage')
